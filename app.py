...
# ── One-time: sync pickup_config data to production ───────────────────────────
@app.route('/admin/sync-pickup-config')
def admin_sync_pickup_config():
    """One-time: sync all pickup_config contact/block/rate/cutoff data from local to production."""
    user = get_current_user()
    if not user or not has_permission(user, 'admin_panel'):
        return 'Forbidden — admin login required.', 403

    db = get_db()
    # Tuples: (id, hotel, hotel_contact, hotel_contact_email, group_contact, group_contact_email,
    #           contracted_block, contracted_rate, cutoff_date)
    updates = [
        (1, 'Portola Hotel & Spa', 'William Clark', 'wclark@portolahotel.com', 'Jess Peterson', 'evp@rangelands.org', '{"2026-02-05": 0, "2026-02-06": 18, "2026-02-07": 125, "2026-02-08": 188, "2026-02-09": 275, "2026-02-10": 268, "2026-02-11": 165, "2026-02-12": 55, "2026-02-13": 8, "2026-02-14": 0}', 254.0, '2026-01-16'),
        (2, 'Marriott', 'William Clark', 'wclark@portolahotel.com', 'Jess Peterson', 'evp@rangelands.org', '{"2026-02-05": 0, "2026-02-06": 17, "2026-02-07": 126, "2026-02-08": 189, "2026-02-09": 249, "2026-02-10": 256, "2026-02-11": 165, "2026-02-12": 56, "2026-02-13": 7, "2026-02-14": 0}', 256.0, '2026-01-16'),
        (3, 'Holiday Inn at the Campus', 'Brista Colandrea', 'sales_manhi@nhihotels.com', None, None, '{"2026-01-20": 0, "2026-01-21": 21, "2026-01-22": 31, "2026-01-23": 31, "2026-01-24": 0, "2026-01-25": 0}', 122.39, '2025-12-30'),
        (6, 'Des Moines Marriott Downtown', 'Sara Gabriel', 'Sara.Gabriel@marriott.com', None, 'Test@None', '{"2026-04-15": 0, "2026-04-16": 5, "2026-04-17": 10, "2026-04-18": 70, "2026-04-19": 100, "2026-04-20": 95, "2026-04-21": 85, "2026-04-22": 10}', 143.31, '2026-03-25'),
        (7, 'Hilton Columbus Downtown', 'Lindsey Fisher', 'lindsey.fisher@hilton.com', 'Rosina Romano', 'rromano@entsoc.org', '{"2026-06-28": 20, "2026-06-29": 20}', 179.0, '2026-06-29'),
        (8, 'Grand Hyatt Vail', 'Kellie Donnelly', 'kellie.donnelly@hyatt.com', 'Julie Baker', 'jbaker@coloradorea.org', '{"2026-09-20": 20, "2026-09-21": 120, "2026-09-22": 120, "2026-09-23": 110, "2026-09-26": 370}', 235.0, '2026-09-26'),
        (9, 'Marriott Long Beach', 'Jessica Martinez', 'jessica.martinez4@marriott.com', 'Lizzie Leopold', 'lleopold@dancestudiesassociation.org', '{"2026-10-22": 90, "2026-10-23": 90, "2026-10-24": 75, "2026-10-25": 5}', 199.0, '2026-10-25'),
        (10, 'Westin Westminster', 'Kathy Byrne', 'kathy.byrne@westinwestminster.com', 'Julie Baker', 'jbaker@coloradorea.org', '{"2026-10-30": 25, "2026-10-31": 75, "2026-11-01": 135, "2026-11-02": 90}', 169.0, '2026-11-02'),
        (11, 'Hilton Madison Monona Terrace Hotel', 'Ranette Maurer', 'rmaurer@hiltonmadison.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-08": 0, "2026-07-09": 4, "2026-07-10": 21, "2026-07-11": 79, "2026-07-12": 170, "2026-07-13": 175, "2026-07-14": 173, "2026-07-15": 173, "2026-07-16": 168}', 178.56, '2026-06-22'),
        (12, 'Madison Concourse Hotel', 'Kelly Gwiazda', 'kgwiazda@concoursehotel.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-08": 0, "2026-07-09": 2, "2026-07-10": 12, "2026-07-11": 45, "2026-07-12": 97, "2026-07-13": 100, "2026-07-14": 99, "2026-07-15": 99, "2026-07-16": 96}', 187.8, '2026-06-22'),
        (13, 'Best Western Premier Park Hotel', 'David Moser', 'dmoser@parkhotelmadison.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-08": 0, "2026-07-09": 3, "2026-07-10": 18, "2026-07-11": 68, "2026-07-12": 146, "2026-07-13": 150, "2026-07-14": 149, "2026-07-15": 149, "2026-07-16": 144}', 214.11, '2026-06-22'),
        (14, "Madison Concourse Hotel and Governor's Club", 'Kelly Gwiazda', 'kgwiazda@concoursehotel.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-17": 5, "2026-07-18": 26, "2026-07-19": 74, "2026-07-20": 90, "2026-07-21": 89, "2026-07-22": 72, "2026-07-23": 12, "2026-07-24": 1, "2026-07-25": 0}', 199.0, '2026-06-29'),
        (15, 'Hyatt Place Madison Downtown', 'Kaite Schelitzche', 'kaite.schelitzche@hyatt.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-17": 3, "2026-07-18": 15, "2026-07-19": 41, "2026-07-20": 50, "2026-07-21": 49, "2026-07-22": 40, "2026-07-23": 7, "2026-07-24": 0, "2026-07-25": 0}', 189.0, '2026-06-29'),
        (16, 'Hilton Madison Monona Terrace', 'Ranette Maurer', 'rmaurer@hiltonmadison.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-17": 10, "2026-07-18": 51, "2026-07-19": 144, "2026-07-20": 175, "2026-07-21": 173, "2026-07-22": 140, "2026-07-23": 23, "2026-07-24": 2, "2026-07-25": 0}', 196.0, '2026-06-29'),
        (17, 'AC Hotel Madison Downtown', 'Jen Hlavachek', 'jhlavachek@ncghotels.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-17": 3, "2026-07-18": 15, "2026-07-19": 41, "2026-07-20": 50, "2026-07-21": 49, "2026-07-22": 40, "2026-07-23": 7, "2026-07-24": 0, "2026-07-25": 0}', 199.0, '2026-06-29'),
        (18, 'Best Western Premier Park Hotel', 'David Moser', 'dmoser@parkhotelmadison.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2026-07-17": 5, "2026-07-18": 29, "2026-07-19": 85, "2026-07-20": 100, "2026-07-21": 99, "2026-07-22": 80, "2026-07-23": 13, "2026-07-24": 1, "2026-07-25": 0}', 199.0, '2026-06-29'),
        (19, 'Embassy Suites Madison Downtown', 'Angela Mago', 'mago@raymondteam.com', 'Melissa Burnett', 'melissab@asas.org', '{"2026-07-17": 57, "2026-07-18": 30, "2026-07-19": 63, "2026-07-20": 75, "2026-07-21": 72, "2026-07-22": 60, "2026-07-23": 9, "2026-07-24": 1, "2026-07-25": 0}', 189.0, '2026-06-29'),
        (20, 'Embassy Suites Atlanta Buckhead', 'Tonya Wright', 'tonya.wright2@hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-02-05": 3, "2026-02-06": 40, "2026-02-07": 40}', 157.81, '2026-01-15'),
        (22, 'Holiday Inn Washington Capitol - National Mall', 'Laura Studebaker', 'laura.studebaker@hicdc.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-05": 12, "2026-05-06": 2}', 276.0, '2026-04-14'),
        (23, 'Hyatt Centric Rittenhouse Square', 'Douglas Ramey', 'douglas.rameyiii@hyatt.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-06": 64, "2026-05-07": 67, "2026-05-08": 12}', 225.0, '2026-04-15'),
        (26, 'Hotel Monteleone', 'Terri Lamonte', 'TLamonte@hotelmonteleone.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-07": 25, "2026-05-08": 5}', 255.0, '2026-04-16'),
        (27, 'Sheraton Centre Toronto Hotel', 'Jeremy Adu', None, 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-13": 30, "2026-05-14": 140, "2026-05-15": 120, "2026-05-16": 20}', 363.32, '2026-04-22'),
        (28, 'Moxy Denver Cherry Creek', 'Michelle Kelley', 'michelle.kelley@denverycy.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-18": 18, "2026-05-19": 18, "2026-05-20": 18, "2026-05-21": 2}', 215.0, '2026-04-27'),
        (29, 'Brickell Arch', 'Gilbert Aviles', None, 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-26": 6, "2026-05-27": 34, "2026-05-28": 34, "2026-05-29": 34}', 269.0, '2026-05-05'),
        (30, 'Hilton Garden Inn Denver/Cherry Creek', 'Lourdes Johnson', 'Lourdes.Johnson@Hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-27": 27, "2026-05-28": 25}', 159.0, '2026-05-06'),
        (31, 'Hotel Monteleone', 'Joyce Choong', 'jchoong@hotelmonteleone.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-01": 12, "2026-06-02": 12, "2026-06-03": 77, "2026-06-04": 115, "2026-06-05": 5, "2026-06-07": 221}', 219.0, '2026-05-11'),
        (32, 'The Foundry Hotel', 'Kathyrn Dewey', 'kdewey@foundryasheville.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-01": 34, "2026-06-02": 28, "2026-06-07": 62}', 249.0, '2026-05-11'),
        (33, 'Waikiki Beach Marriott Resort & Spa', 'Kimberly Forte', 'kimberly.forte@marriott.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-17": 25, "2026-06-18": 25, "2026-06-19": 23}', 229.0, '2026-05-27'),
        (34, 'The Westin La Paloma Resort & Spa', 'Howard Schumacher', 'schumacherh@gfhotels.com', None, None, '{"2027-11-07": 37, "2027-11-08": 45, "2027-11-09": 42, "2027-11-10": 31, "2027-11-11": 50, "2027-11-12": 53, "2027-11-13": 43, "2027-11-14": 25}', 184.0, '2026-06-15'),
        (35, 'Westin Calgary', 'Lacy Garvey', 'lacy.garvey@westin.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-07-08": 30, "2026-07-09": 130, "2026-07-10": 130, "2026-07-11": 130, "2026-07-12": 130, "2026-07-13": 10}', 439.0, '2026-06-17'),
        (36, 'Drury Plaza Hotel Santa Fe', 'Jenny Tercero', 'jenny.tercero@druryhotels.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-08-31": 55, "2026-09-01": 55, "2026-09-02": 10}', 189.0, '2026-08-10'),
        (37, 'The Art Hotel', 'Todd Payton', 'todd.payton@hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-12": 21, "2026-09-13": 80, "2026-09-14": 80, "2026-09-15": 80, "2026-09-16": 80, "2026-09-17": 70}', 224.0, '2026-08-22'),
        (38, 'The Darcy Hotel', 'Robert Spargur', 'robert.spargur@thedarcyhotel.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-14": 42, "2026-09-15": 41, "2026-09-16": 5}', 229.0, '2026-08-24'),
        (39, 'Element Hotel Lexington', 'Brianna Magee', 'brianna.magee@marriott.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-23": 16, "2026-09-24": 60, "2026-09-25": 60}', 158.0, '2026-09-02'),
        (41, 'Marriott Raleigh City Center', 'Jiran Hafshejani', 'jiran.hafshejani@marriottraleigh.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-29": 23, "2026-09-30": 143, "2026-10-01": 153, "2026-10-02": 153, "2026-10-03": 123}', 239.0, '2026-09-08'),
        (42, 'Embassy Suites Hilton Minneapolis Downtown', 'Andrew Koven', 'ndrew.koven@hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-27": 13, "2026-09-28": 94, "2026-09-29": 94, "2026-09-30": 94, "2026-10-01": 10}', 159.0, '2026-09-06'),
        (43, 'Kimpton Hotel Monaco Pittsburgh', 'Emily Hosler', 'emily.hosler@monaco-pittsburgh.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-10-05": 41, "2026-10-06": 72, "2026-10-07": 77, "2026-10-08": 77, "2026-10-09": 5}', 219.0, '2026-09-14'),
        (44, 'Hyatt Regency Washington DC on Capitol Hill', 'Kate Sullivan', 'kate.sullivan@hyatt.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-10-03": 85, "2026-10-04": 195, "2026-10-05": 195, "2026-10-06": 195, "2026-10-07": 195, "2026-10-08": 30}', 315.0, '2026-09-12'),
        (45, 'The Grove Hotel', 'Kathy Schofield', 'schofield@block22hotels.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-10-06": 53, "2026-10-07": 53, "2026-10-08": 53}', 209.0, '2026-09-15'),
        (46, 'AC Hotel Columbus Downtown', 'Nailey Urich', 'bailey.urich@concordhotels.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-10-14": 50, "2026-10-15": 50}', 209.0, '2026-09-23'),
        (47, 'Hilton Salt Lake City', 'Austin Burdette', 'austin.burdette@hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-10-11": 170, "2026-10-12": 170, "2026-10-13": 170, "2026-10-14": 15}', 169.0, '2026-09-20'),
        (48, 'Hotel Monteleone', 'Terri Lamonte', 'lamonte@hotelmonteleone.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2027-01-13": 25, "2027-01-14": 130, "2027-01-15": 130, "2027-01-16": 100}', 279.0, '2026-12-23'),
        (49, 'Embassy Suites by Hilton Charleston West Virginia', 'Alysse Barfell', 'alysse.barfell@atriumhospitality.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-09-24": 87, "2026-09-25": 195, "2026-09-26": 195, "2026-09-27": 195, "2026-09-28": 195, "2026-09-29": 30}', 134.0, '2027-09-04'),
        (50, 'Sheraton Denver West', 'Jennifer Kickbush', 'kickbush@sdwhotel,com', 'Julie Baker', 'jbaker@coloradorea.org', '{"2026-03-25": 5, "2026-03-26": 15, "2026-03-27": 3}', 99.0, '2026-03-18'),
        (51, 'Hilton Columbus Downtown', 'Andrea Barker', 'andrea.barker@hilton.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-27": 8, "2027-10-28": 16, "2027-10-29": 88, "2027-10-30": 352, "2027-10-31": 776, "2027-11-01": 800, "2027-11-02": 744, "2027-11-03": 416, "2027-11-04": 40, "2027-11-05": 8}', 239.0, '2027-10-11'),
        (52, 'Hyatt Regency Columbus', 'Pierre Le', 'pierre.le@hyatt.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-27": 5, "2027-10-28": 9, "2027-10-29": 50, "2027-10-30": 198, "2027-10-31": 437, "2027-11-01": 450, "2027-11-02": 419, "2027-11-03": 234, "2027-11-04": 23, "2027-11-05": 5}', 238.0, '2027-10-11'),
        (53, 'Drury Inn & Suites Convention Centre', 'Jenny Wellman', 'jenny.wellman@druryhotels.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-27": 1, "2027-10-28": 3, "2027-10-29": 15, "2027-10-30": 59, "2027-10-31": 131, "2027-11-01": 135, "2027-11-02": 126, "2027-11-03": 70, "2027-11-04": 7, "2027-11-05": 1}', 199.0, '2027-10-11'),
        (54, 'AC Hotel Columbus Downtown', 'Diana Marshall', 'diana.marshall@concordhotels.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-28": 1, "2027-10-29": 7, "2027-10-30": 26, "2027-10-31": 58, "2027-11-01": 60, "2027-11-02": 56, "2027-11-03": 31, "2027-11-04": 3}', 269.0, '2027-10-11'),
        (55, 'Hampton Inn & Suites Columbus-Downtown', 'Diana Mourer', 'diana.mourer@hilton.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-27": 1, "2027-10-28": 2, "2027-10-29": 10, "2027-10-30": 40, "2027-10-31": 87, "2027-11-01": 90, "2027-11-02": 84, "2027-11-03": 47, "2027-11-04": 5, "2027-11-05": 1}', 209.0, '2027-10-11'),
        (56, 'Red Roof PLUS+ Columbus Downtown', 'Linda Karcher', 'linda.karcher@rriwest.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2027-10-28": 2, "2027-10-29": 9, "2027-10-30": 37, "2027-10-31": 82, "2027-11-01": 85, "2027-11-02": 79, "2027-11-03": 44, "2027-11-04": 4}', 175.0, '2027-10-11'),
        (57, 'Galt House', 'Rob Hanlin - Sales', None, 'Abbi Levin', 'abbi@grazinglands.org', '{"2027-12-03": 5, "2027-12-04": 50, "2027-12-05": 265, "2027-12-06": 308, "2027-12-07": 308, "2027-12-08": 208, "2027-12-09": 53, "2027-12-10": 10}', 161.82, '2027-11-12'),
        (58, 'Hyatt Regency Tulsa Downtown', 'Lori Long', 'lori.long@hyatt.com', 'Alvaro Romero', 'alvaro.romero@envu.com', '{"2027-02-27": 60, "2027-02-28": 30, "2027-03-01": 65, "2027-03-02": 70, "2027-03-03": 50}', 132.73, '2027-02-05'),
        (59, 'Princess Royale Oceanfront Resort', 'Nicole Wietstruk', 'nicole@princessroyale.com', 'Simon Zebelo', 'sazebelo@umes.edu', '{"2027-03-05": 10, "2027-03-06": 80, "2027-03-07": 95, "2027-03-08": 60}', 129.0, '2027-02-12'),
        (60, 'Hilton Portland Downtown', 'Andrew Haddad', 'andrea.haddad@hilton.com', 'Angelita Acebes-Doria', 'angelita.acebes-doria@usda.gov', '{"2027-03-13": 40, "2027-03-14": 100, "2027-03-15": 120, "2027-03-16": 110, "2027-03-17": 10}', 152.97, '2027-02-22'),
        (61, 'Hilton Garden Inn & Manhattan Conference Center', 'Alisa Drum', 'alisa.drum@hilton.com', 'Rob Morrison', 'william.morrison@usda.gov', '{"2027-04-24": 60, "2027-04-25": 100, "2027-04-26": 95, "2027-04-27": 85, "2027-04-28": 10}', 134.0, '2027-04-05'),
        (62, 'Omni Fort Lauderdale', 'Aaron Weegar', 'aaron.weegar@omnihotels.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2028-11-08": 2, "2028-11-09": 11, "2028-11-10": 91, "2028-11-11": 336, "2028-11-12": 675, "2028-11-13": 700, "2028-11-14": 652, "2028-11-15": 336, "2028-11-16": 49, "2028-11-17": 5}', 319.0, '2028-10-18'),
        (63, 'Hilton Fort Lauderdale Marina', 'Nancy Rossero', 'nancy.rossero@hilton.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2028-11-08": 1, "2028-11-09": 6, "2028-11-10": 45, "2028-11-11": 168, "2028-11-12": 340, "2028-11-13": 350, "2028-11-14": 325, "2028-11-15": 168, "2028-11-16": 24, "2028-11-17": 4}', 257.0, '2028-10-23'),
        (64, 'Renaissance', None, None, None, None, '{"2022-11-03": 1, "2022-11-04": 2, "2022-11-05": 13, "2022-11-06": 48, "2022-11-07": 97, "2022-11-08": 100, "2022-11-09": 93, "2022-11-10": 48, "2022-11-11": 7}', 249.0, None),
        (65, 'Embassy Suites by Hilton Fort Lauderdale', 'Tammy Amoroso', 'tammy.amoroso@hilton.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2028-11-08": 1, "2028-11-09": 3, "2028-11-10": 26, "2028-11-11": 96, "2028-11-12": 194, "2028-11-13": 200, "2028-11-14": 186, "2028-11-15": 96, "2028-11-16": 14}', 249.0, '2028-10-23'),
        (66, 'Hyatt Place Fort Lauderdale Airport', 'Andrew Volkmann', 'andrew.volkmann@hyatt.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2028-11-09": 1, "2028-11-10": 6, "2028-11-11": 24, "2028-11-12": 48, "2028-11-13": 50, "2028-11-14": 46, "2028-11-15": 24, "2028-11-16": 3}', 249.0, '2028-10-23'),
        (67, 'Fort Lauderdale Marriott Harbor Beach', 'Emily Orsini', 'emily.orsini@marriott.com', 'Jeanne Pluemer', 'jpluemer@sciencesocieties.org', '{"2028-11-08": 1, "2028-11-09": 1, "2028-11-10": 13, "2028-11-11": 48, "2028-11-12": 97, "2028-11-13": 100, "2028-11-14": 93, "2028-11-15": 48, "2028-11-16": 7}', 307.0, '2028-10-23'),
        (69, 'Hyatt Regency SLC', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 2, "2030-11-08": 17, "2030-11-09": 90, "2030-11-10": 448, "2030-11-11": 550, "2030-11-12": 560, "2030-11-13": 538, "2030-11-14": 263, "2030-11-15": 11}', 289.0, None),
        (70, 'Radisson', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 6, "2030-11-08": 32, "2030-11-09": 160, "2030-11-10": 196, "2030-11-11": 200, "2030-11-12": 192, "2030-11-13": 94, "2030-11-14": 4}', 239.0, None),
        (71, 'Hilton', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 2, "2030-11-08": 11, "2030-11-09": 56, "2030-11-10": 280, "2030-11-11": 343, "2030-11-12": 350, "2030-11-13": 336, "2030-11-14": 165, "2030-11-15": 7}', 251.0, None),
        (72, 'Holiday Inn Express', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 5, "2030-11-08": 24, "2030-11-09": 120, "2030-11-10": 147, "2030-11-11": 150, "2030-11-12": 144, "2030-11-13": 71, "2030-11-14": 3}', 189.0, None),
        (73, 'Marriott Downtown City Creek', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 8, "2030-11-08": 40, "2030-11-09": 200, "2030-11-10": 245, "2030-11-11": 250, "2030-11-12": 240, "2030-11-13": 118, "2030-11-14": 5}', 269.0, None),
        (74, 'Courtyard Salt Lake City Downtown', None, None, 'Rosina Romano', 'rromano@entsoc.org', '{"2030-11-07": 2, "2030-11-08": 9, "2030-11-09": 44, "2030-11-10": 54, "2030-11-11": 55, "2030-11-12": 53, "2030-11-13": 26, "2030-11-14": 1}', 209.0, None),
        (77, 'Des Moines Marriott Downtown', 'Whitney Breitbach', 'whitney.breitbach@marriott.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2027-03-13": 8, "2027-03-14": 103, "2027-03-15": 150, "2027-03-16": 133, "2027-03-17": 9}', 173.24, '2027-02-22'),
        (78, 'Hilton Des Moines', 'Tamara Chubb', 'tamara.chubb@hilton.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2027-03-13": 13, "2027-03-14": 138, "2027-03-15": 200, "2027-03-16": 178, "2027-03-17": 11}', 157.55, '2027-02-22'),
        (79, 'Renaissance Des Moines Savery Hotel', 'Christie Shull-Wendel', 'christie.shull-wendel@renaissancehotels.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2027-03-13": 5, "2027-03-14": 59, "2027-03-15": 86, "2027-03-16": 76, "2027-03-17": 5}', 146.33, '2027-02-22'),
        (80, 'Des Moines Marriott Downtown', 'Whitney Breitbach', 'whitney.breitbach@marriott.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2028-03-11": 8, "2028-03-12": 103, "2028-03-13": 150, "2028-03-14": 133, "2028-03-15": 9}', 182.25, '2027-02-22'),
        (81, 'Hilton Des Moines', 'Tamara Chubb', 'tamara.chubb@hilton.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2028-03-11": 13, "2028-03-12": 138, "2028-03-13": 200, "2028-03-14": 178, "2028-03-15": 11}', 166.62, '2027-02-22'),
        (82, 'Renaissance Des Moines Savery Hotel', 'Christie Shull-Wendel', 'christie.shull-wendel@renaissancehotels.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2028-03-11": 5, "2028-03-12": 59, "2028-03-13": 86, "2028-03-14": 76, "2028-03-15": 5}', 150.86, '2027-02-22'),
        (83, 'Le Westin Montreal', 'Edison Wong', 'wong@westinmontreal.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2029-06-22": 18, "2029-06-23": 103, "2029-06-24": 225, "2029-06-25": 250, "2029-06-26": 249, "2029-06-27": 225, "2029-06-28": 50, "2029-06-29": 15}', 348.74, '2029-06-01'),
        (84, 'Hilton Des Moines', 'Tamara Chubb', 'tamara.chubb@hilton.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2029-06-22": 14, "2029-06-23": 82, "2029-06-24": 180, "2029-06-25": 200, "2029-06-26": 198, "2029-06-27": 180, "2029-06-28": 40, "2029-06-29": 12}', None, '2029-06-01'),
        (85, 'Renaissance Des Moines Savery Hotel', 'Christie Shull-Wendel', 'christie.shull-wendel@renaissancehotels.com', 'Meghan Wulster-Radcliffe', 'meghanwr@asas.org', '{"2029-06-22": 7, "2029-06-23": 41, "2029-06-24": 90, "2029-06-25": 100, "2029-06-26": 99, "2029-06-27": 90, "2029-06-28": 20, "2029-06-29": 6}', None, '2029-06-01'),
        (88, 'Kimpton Hotel Monaco Pittsburgh', 'Shirleen Finney', 'shirleen.finney@monaco-pittsburgh.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-27": 45, "2026-05-28": 45, "2026-05-29": 45}', 229.0, '2026-05-06'),
        (89, 'Kimpton Armory Hotel Bozeman', 'Dana Ocher', 'Dana.Ocher@armoryhotelbzn.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-05-27": 43, "2026-05-28": 43, "2026-05-29": 5}', 299.0, '2026-05-06'),
        (90, 'Hotel Champlain', 'Lynn Berardinelli', 'lynn.berardinelli@aimbridge.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-01": 3, "2026-06-02": 39, "2026-06-03": 41, "2026-06-04": 39}', 259.0, '2026-05-11'),
        (91, 'Doubletree Austin Capitol', 'Rebecca Donovan', 'rebecca.donovan@hilton.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-01": 37, "2026-06-02": 60, "2026-06-03": 60, "2026-06-04": 60, "2026-06-05": 10}', 194.0, '2026-05-11'),
        (92, 'Moxy Cherry Creek', 'Michelle Kelley', 'michelle.kelley@denvercy.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-06-10": 45, "2026-06-11": 45, "2026-06-12": 45, "2026-06-13": 45, "2026-06-14": 45, "2026-06-15": 45, "2026-06-16": 45}', 215.0, '2026-05-20'),
        (93, 'The Blackstone', 'Jamie Kramer', 'jennifer.kramer@theblackstonehotel.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-07-24": 4, "2026-07-25": 24, "2026-07-26": 68, "2026-07-27": 75, "2026-07-28": 75, "2026-07-29": 53, "2026-07-30": 2}', 289.0, '2026-07-03'),
        (94, 'Le Meridien', 'Daniel Grajdura', 'daniel.grajdura@ohrllc.com', 'Marisa Sterling-Abram', 'marisa.sterlingabram@ncsl.org', '{"2026-07-24": 4, "2026-07-25": 24, "2026-07-26": 68, "2026-07-27": 75, "2026-07-28": 75, "2026-07-29": 53, "2026-07-30": 2}', 289.0, '2026-07-03'),
        (95, 'Hilton Niagara Falls', None, None, 'Kristina Tarantino', 'ktarantino@sciencesocieties.org', '{"2026-08-24": 25, "2026-08-25": 40, "2026-08-26": 40, "2026-08-27": 25}', 249.0, '2026-07-27'),
        (96, 'Embassy Suites', 'Jamie Beatty', 'jamie.beatty@ohospitalitymanagement.com', 'Michelle Thorn', 'michelle@ieca.org', '{"2026-10-06": 5, "2026-10-07": 55, "2026-10-08": 50}', 163.5, '2026-09-15'),
        (97, 'Shangri-La', 'Kim Havenhand', 'Kim.Havenhand@shangri-la.com', 'Samantha Roe', 'samantha@ieca.org', '{"2026-10-20": 30, "2026-10-21": 50, "2026-10-22": 50, "2026-10-23": 10}', 460.0, '2026-09-30'),
        (98, 'Hilton', 'Kristi Curtis', 'kristi.curtis@hilton.com', 'Michelle Thorn', 'michelle@ieca.org', '{"2026-11-04": 15, "2026-11-05": 35}', 142.0, '2026-10-14'),
    ]

    count = 0
    skipped = 0
    for row in updates:
        (id_, hotel, hc, hce, gc, gce, block, rate, cutoff) = row
        result = db.execute(
            '''UPDATE pickup_config
               SET hotel=?, hotel_contact=?, hotel_contact_email=?,
                   group_contact=?, group_contact_email=?,
                   contracted_block=?, contracted_rate=?, cutoff_date=?
               WHERE id=?''',
            (hotel, hc, hce, gc, gce, block, rate, cutoff, id_)
        )
    ...
    html = '<h3>Pickup Config Sync — Results</h3>'
    html += f'<p><strong>{count}</strong> record(s) updated. <strong>{skipped}</strong> not found (skipped).</p>'
    html += '<p><a href="/pickup">Go to Pickup Tracking</a></p>'
    return html
