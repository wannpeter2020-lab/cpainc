...
@app.route('/admin/apply-may2026-updates')
def admin_apply_may2026_updates():
    """One-shot endpoint: archive duplicates, set group contacts, fill Portland/Columbus data."""
    user = get_current_user()
    if not user or not has_permission(user, 'admin_panel'):
    ...
    # 1. Archive duplicate records
    for pid in (87, 105, 106):
        db.execute("UPDATE pickup_config SET status='archived' WHERE id=?", (pid,))
        log.append(f'Archived id={pid}')

    # 2. Group contact updates only
    group_contacts = {
        21:  'marisa.sterlingabram@ncsl.org',
        24:  'marisa.sterlingabram@ncsl.org',
        40:  'marisa.sterlingabram@ncsl.org',
        75:  'meghanwr@asas.org',
        76:  'meghanwr@asas.org',
        86:  'marisa.sterlingabram@ncsl.org',
        107: 'jpluemer@sciencesocieties.org',
        109: 'marisa.sterlingabram@ncsl.org',
        110: 'jpluemer@sciencesocieties.org',
        124: 'michelle@ieca.org',
        125: 'michelle@ieca.org',
    }
    for pid, email in group_contacts.items():
        db.execute("UPDATE pickup_config SET group_contact_email=? WHERE id=?", (email, pid))
        log.append(f'Set group_contact id={pid} -> {email}')

    # 3. Portland hotels (IDs 111-117) — full update
    portland = [
        (111, 'nnellist@portlanddoubletree.com',     'jpluemer@sciencesocieties.org', '2026-10-12', 205.0,
         '{"2026-10-28":4,"2026-10-29":8,"2026-10-30":44,"2026-10-31":188,"2026-11-01":388,"2026-11-02":400,"2026-11-03":372,"2026-11-04":180,"2026-11-05":20,"2026-11-06":4}'),
        (112, 'meliza@hollanderhospitality.com',     'jpluemer@sciencesocieties.org', '2026-10-12', 209.0,
         '{"2026-10-28":1,"2026-10-29":2,"2026-10-30":14,"2026-10-31":61,"2026-11-01":126,"2026-11-02":130,"2026-11-03":121,"2026-11-04":59,"2026-11-05":6,"2026-11-06":1}'),
        (113, 'justin.evans@hyatt.com',              'jpluemer@sciencesocieties.org', '2026-10-12', 235.0,
         '{"2026-10-28":10,"2026-10-29":11,"2026-10-30":55,"2026-10-31":235,"2026-11-01":485,"2026-11-02":500,"2026-11-03":465,"2026-11-04":225,"2026-11-05":28,"2026-11-06":5}'),
        (114, 'dmcdowell@hoteleastlund.com',         'jpluemer@sciencesocieties.org', '2026-10-12', 219.0,
         '{"2026-10-28":1,"2026-10-29":2,"2026-10-30":11,"2026-10-31":47,"2026-11-01":97,"2026-11-02":100,"2026-11-03":93,"2026-11-04":45,"2026-11-05":5,"2026-11-06":1}'),
        (115, 'robert.tate@hilton.com',              'jpluemer@sciencesocieties.org', '2026-10-12', 219.0,
         '{"2026-10-28":3,"2026-10-29":6,"2026-10-30":32,"2026-10-31":136,"2026-11-01":281,"2026-11-02":290,"2026-11-03":270,"2026-11-04":130,"2026-11-05":15,"2026-11-06":3}'),
        (116, 'LHarley@csmcorp.net',                 'jpluemer@sciencesocieties.org', '2026-10-12', 224.0,
         '{"2026-10-28":1,"2026-10-29":2,"2026-10-30":11,"2026-10-31":47,"2026-11-01":97,"2026-11-02":100,"2026-11-03":93,"2026-11-04":45,"2026-11-05":5,"2026-11-06":1}'),
        (117, 'mark.brennan@innatcc.com',            'jpluemer@sciencesocieties.org', '2026-10-12', 185.0,
         '{"2026-10-28":1,"2026-10-29":2,"2026-10-30":9,"2026-10-31":38,"2026-11-01":78,"2026-11-02":80,"2026-11-03":74,"2026-11-04":36,"2026-11-05":4,"2026-11-06":1}'),
    ]
    for pid, hemail, gemail, cutoff, rate, block in portland:
        db.execute("""UPDATE pickup_config SET hotel_contact_email=?, group_contact_email=?,
                      cutoff_date=?, contracted_rate=?, contracted_block=? WHERE id=?""",
                   (hemail, gemail, cutoff, rate, block, pid))
        log.append(f'Portland full-update id={pid}')

    # 4. Columbus hotels (IDs 118-123) — full update
    columbus = [
        (118, 'pierre.le@hyatt.com',            'rromano@entsoc.org', '2026-10-16', 219.0,
         '{"2026-11-04":2,"2026-11-05":9,"2026-11-06":36,"2026-11-07":337,"2026-11-08":428,"2026-11-09":450,"2026-11-10":405,"2026-11-11":171,"2026-11-12":2}'),
        (119, 'andrea.barker@hilton.com',        'rromano@entsoc.org', '2026-10-16', 229.0,
         '{"2026-11-04":3,"2026-11-05":12,"2026-11-06":95,"2026-11-07":486,"2026-11-08":612,"2026-11-09":630,"2026-11-10":599,"2026-11-11":234,"2026-11-12":13}'),
        (120, 'jenny.wellman@druryhotels.com',   'rromano@entsoc.org', '2026-10-16', 199.0,
         '{"2026-11-05":3,"2026-11-06":21,"2026-11-07":101,"2026-11-08":127,"2026-11-09":130,"2026-11-10":125,"2026-11-11":49,"2026-11-12":3}'),
        (121, 'diana.mourer@hilton.com',         'rromano@entsoc.org', '2026-10-16', 194.0,
         '{"2026-11-05":2,"2026-11-06":14,"2026-11-07":69,"2026-11-08":87,"2026-11-09":90,"2026-11-10":86,"2026-11-11":34,"2026-11-12":1}'),
        (122, 'Lindsay.mulch2@marriott.com',     'rromano@entsoc.org', '2026-10-16', 159.0,
         '{"2026-11-05":2,"2026-11-06":13,"2026-11-07":62,"2026-11-08":78,"2026-11-09":80,"2026-11-10":77,"2026-11-11":30,"2026-11-12":2}'),
        (123, 'karijo.deaton@ihg.com',           'rromano@entsoc.org', '2026-10-16', 205.0,
         '{"2026-11-05":2,"2026-11-06":15,"2026-11-07":77,"2026-11-08":97,"2026-11-09":100,"2026-11-10":95,"2026-11-11":37,"2026-11-12":1}'),
    ]
    for pid, hemail, gemail, cutoff, rate, block in columbus:
        db.execute("""UPDATE pickup_config SET hotel_contact_email=?, group_contact_email=?,
                      cutoff_date=?, contracted_rate=?, contracted_block=? WHERE id=?""",
                   (hemail, gemail, cutoff, rate, block, pid))
        log.append(f'Columbus full-update id={pid}')

    db.commit()
    return _j.dumps({'ok': True, 'steps': len(log), 'log': log}, indent=2), 200, {'Content-Type': 'application/json'}
